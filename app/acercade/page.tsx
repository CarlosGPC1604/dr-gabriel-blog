      ...
      <main className="container mx-auto px-4 py-8 flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <p className="text-lg mb-4">
            El Dr. Gabriel López es un reconocido especialista en urología con más de 15 años de experiencia en el campo de la salud masculina. Graduado de la Universidad Nacional de Medicina, el Dr. López ha dedicado su carrera a brindar atención personalizada y de calidad a sus pacientes.
          </p>
          <p className="text-lg mb-4">
